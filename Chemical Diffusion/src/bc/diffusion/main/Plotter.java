...
public abstract class Plotter extends JPanel {
	...
	public void layGrid(Graphics g){
		...
		g.drawLine((int) (width - lift - 2), (int) lift + 2, (int) (width - lift - 2), 0);
		g.drawString("Y", (int) (width - lift - 20), height / 2);
		g.drawLine((int) (width - lift - 2), (int) lift + 2, width, (int) lift + 2);
		g.drawString("X", width / 2, (int) (lift + 20));
		g.drawLine((int)(width - lift - 2), (int)(lift - maxHeight - 2), width - 2, (int)(lift - maxHeight - 2));
